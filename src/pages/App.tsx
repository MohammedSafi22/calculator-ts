        ...
        <header className="form-header">
          <article className="form-header_content">
            ...
            <p className="form-info">
              ...
              reprehenderit voluptas? Laudantium tempora temporibus ab,
              praesentium vel ea placeat numquam eum at beatae quas repellat,
              similique, exercitationem a maxime dolores ducimus! Accusamus
              quisquam, voluptatem fugit hic omnis minima quam ipsa?
            </p>
          </article>
